class BillingAddressesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @billing_address.save
        format.html { redirect_to new_order_path, notice: 'Billing address was successfully created.' }
  ...
  private
    ...
    def billing_address_params
      params.require(:billing_address).permit(*Address.column_names.map(&:to_sym))
    end
end
