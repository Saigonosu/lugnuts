class ShippingAddressesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @shipping_address.save
        format.html { redirect_to new_order_path, notice: 'Shipping address was successfully created.' }
  ...
  private
    ...
    def shipping_address_params
      params.require(:shipping_address).permit(*Address.column_names.map(&:to_sym))
    end
end
